...
/**
 * Apunte de seguimiento escrito por un profesor en plan personal.
 * Incluye su propio paciente/estudiante y sesión privada (sin contexto institucional).
 */
export class TeacherPersonalNote implements BaseEntity {
  private _id: number;
  ...
  get sessionInfo(): string { return this._sessionInfo; }
  set sessionInfo(value: string) { this._sessionInfo = value; }
}
