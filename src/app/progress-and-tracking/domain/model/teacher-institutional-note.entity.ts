...
/**
 * Apunte de seguimiento escrito por un profesor en plan institucional.
 * Incluye estudiante afiliado a la institución y sesión institucional.
 */
export class TeacherInstitutionalNote implements BaseEntity {
  private _id: number;
